  ...
  <app-button>Right</app-button>
      ...
      preview: html`
        <div class="flex gap-4 justify-center py-8">
          <app-tooltip text="Bottom tooltip" position="bottom"><app-button variant="outline">Bottom</app-button></app-tooltip>
          <app-tooltip text="Left tooltip" position="left"><app-button variant="outline">Left</app-button></app-tooltip>
          <app-tooltip text="Right tooltip" position="right"><app-button variant="outline">Right</app-button></app-tooltip>
        </div>
      `,
    },
